...
HTuple m_ImageWidth, m_ImageHeight, Type, WindowHandle, pointer, HWindowID;
HObject  Image;
CRect Rect;
...
BEGIN_MESSAGE_MAP(CMFCApplication2Dlg, CDialogEx)
	...
	ON_STN_CLICKED(IDC_STATIC3, &CMFCApplication2Dlg::OnStnClickedStatic3)
END_MESSAGE_MAP()
...
void CMFCApplication2Dlg::OnBnClickedButton1()
{
	...
	OpenWindow(0, 0, Rect.Width(), Rect.Height(), HWindowID, "visible", "", &WindowHandle);
...
void CMFCApplication2Dlg::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
	CDialogEx::OnOK();
	TemplateMatching dlg;
	dlg.DoModal();
}


void CMFCApplication2Dlg::OnStnClickedStatic3()
{
	// TODO: 在此添加控件通知处理程序代码
	HalconCpp::CloseWindow(HWindowID);
}
